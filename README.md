...
This is an end-to-end workflow that finds the genetic changes associated with a trait — antibiotic
resistance, virulence, host — across a collection of *Staphylococcus aureus* genomes, while
